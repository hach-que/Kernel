...
all:
	...
	@echo Linking kernel...
	@ld $(LD_FLAGS) -T link.ld -o out/kernel.bin out/start.o out/scrn.o out/gdt.o out/idt.o out/isrs.o out/irq.o out/timer.o out/kb.o out/mem.o out/string.o out/page.o out/tss.o out/api.o out/app/entry.o out/app/lib.o out/main.o
